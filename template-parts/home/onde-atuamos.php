<section id="onde-atuamos">
    ...
    <div class="container">
        <picture>
            ...
            <img class="imagem-lateral" src="<?= get_field('imagem_lateral_desktop')['url'] ?>"
                alt="<?= get_field('imagem_lateral_desktop')['alt'] ?>">
        </picture>
        <div class="conteudo">
            <img class="imagem-logo" src="<?= get_field("logo_veritas")['url'] ?>"
                alt="<?= get_field("logo_veritas")['alt'] ?>">
